...
class TextThemeProvider {
  ...
  late final h4 = _createFont(contentFont, sizePx: 14, heightPx: 23, spacingPc: 5, weight: FontWeight.w600);

  late final title1 = _createFont(titleFont, sizePx: 16, heightPx: 26, spacingPc: 5);
  late final title2 = _createFont(titleFont, sizePx: 14, heightPx: 16.38);
  ...
  late final btn = _createFont(contentFont, sizePx: 14, weight: FontWeight.w500, spacingPc: 2, heightPx: 14);
